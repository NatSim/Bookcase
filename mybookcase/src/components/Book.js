    ...
    return (
        ...
        <div>
            ...
            <p className="description">{description}</p>
                ...
                {props.bookList && <Button variant="success" className="mt-5 ml-5" onClick = {()=> props.addBook(props.book)}>Add</Button>}
                {!props.bookList && <Button variant="danger" className="mt-5 ml-5" onClick = {()=> props.removeBook(props.book)}>Remove</Button>}
            </Col>
            </Row>
        </div>
    );
